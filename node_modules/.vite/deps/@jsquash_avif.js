...
var isRunningInNode = () => typeof process !== "undefined" && process.release && process.release.name === "node";
...
async function init(module, moduleOptionOverrides) {
  ...
  if (!isRunningInNode() && !isRunningInCloudflareWorker() && await threads()) {
    const avifEncoder2 = await import("./avif_enc_mt-SAYYO42H.js");
    emscriptenModule = initEmscriptenModule(avifEncoder2.default, actualModule, actualOptions);
    return emscriptenModule;
  }
  const avifEncoder = await import("./avif_enc-465IMEYH.js");
...
async function encode(data, options = {}) {
  ...
  if (_options.lossless) {
    ...
    if (options.qualityAlpha !== void 0 && options.qualityAlpha !== 100 && options.qualityAlpha !== -1) {
...
var Module = (() => {
  ...
  return function(moduleArg = {}) {
    ...
    if (isRunningInCloudFlareWorkers || isRunningInNode2) {
    ...
    var wasmImports = { p: __embind_register_bigint, m: __embind_register_bool, l: __embind_register_emval, i: __embind_register_float, x: __embind_register_function, c: __embind_register_integer, b: __embind_register_memory_view, j: __embind_register_std_string, g: __embind_register_std_wstring, o: __embind_register_void, u: __emscripten_throw_longjmp, f: __emval_call, B: __emval_call_method, D: __emval_decref, E: __emval_get_global, e: __emval_get_method_caller, A: __emval_new_cstring, C: __emval_run_destructors, h: __emval_set_property, z: __emval_take_value, a: _abort, v: _emscripten_resize_heap, w: _fd_close, n: _fd_seek, y: _fd_write, d: invoke_iii, r: invoke_iiiii, s: invoke_v, t: invoke_vi, k: invoke_viiii, q: invoke_viiiiiii };
    ...
    var __emscripten_stack_restore = (a0) => (__emscripten_stack_restore = wasmExports["M"])(a0);
    ...
    var dynCall_iiijii = Module2["dynCall_iiijii"] = (a0, a1, a2, a3, a4, a5, a6) => (dynCall_iiijii = Module2["dynCall_iiijii"] = wasmExports["O"])(a0, a1, a2, a3, a4, a5, a6);
    var dynCall_jiji = Module2["dynCall_jiji"] = (a0, a1, a2, a3, a4) => (dynCall_jiji = Module2["dynCall_jiji"] = wasmExports["P"])(a0, a1, a2, a3, a4);
...
async function init2(module, moduleOptionOverrides) {
  ...
  emscriptenModule2 = initEmscriptenModule(avif_dec_default, actualModule, actualOptions);
}
...
//# sourceMappingURL=@jsquash_avif.js.map
